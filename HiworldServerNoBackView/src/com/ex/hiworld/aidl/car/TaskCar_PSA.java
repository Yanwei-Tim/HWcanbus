...
public class TaskCar_PSA extends BaseCar {
	...
	public static final int U_OPTIMAL_OIL_EXPEND			= 2;	// 平均油耗
	public static final int U_DRIVING_TOTAL_MILES			= 3;	// 行车时间
	public static final int U_AVERAGE_SPEED					= 4;	// 平均速度
	public static final int U_OPTIMAL_OIL_EXPEND_2			= 5;	//  
	public static final int U_CAR_CAMERA_MODE				= 6;
	public static final int U_AVERAGE_SPEED_2				= 7;	//  
	public static final int U_DRIVING_TOTAL_MILES_2 		= 8;	//  
...
//	 */
	...
	public static final int U_SET_CAR_TYPE    	 = U_508_SOUND_7+1;
	public static final int U_SET_SOS_STATE    	 = U_508_SOUND_7+2;
	
	public static final int U_CNT_MAX			 = U_508_SOUND_7+10;
	...
	public static final int C_SET_21					= 115; // 模拟面板按键
	...
	private int KeyCanKeyTableDS5L[][]=
	 {
	...
	private int KeyCanKeyTableDS5H[][]=
		 {
		 			{1,			FinalKeyCode.KEY_CODE_VOL_UP},
		 			{2, 		FinalKeyCode.KEY_CODE_VOL_DOWN},		 	
		 			{3, 		FinalKeyCode.KEY_CODE_MUTE},
	...
	private int KeyCanKeyTableDS5LSL[][]=
		 {
		 			{1,			FinalKeyCode.KEY_CODE_VOL_UP},
		 			{2, 		FinalKeyCode.KEY_CODE_VOL_DOWN},		 	
		 			{3, 		FinalKeyCode.KEY_CODE_MUTE},
	...
	private int KeyCanKeyTableDS5LSH[][]=
		 {
		 			{1,			FinalKeyCode.KEY_CODE_VOL_UP},
		 			{2, 		FinalKeyCode.KEY_CODE_VOL_DOWN},		 	
		 			{3, 		FinalKeyCode.KEY_CODE_MUTE},
	...
	private int KeyCanKeyTableDS4L[][]=
		 {
		 			{1,			FinalKeyCode.KEY_CODE_VOL_UP},
		 			{2, 		FinalKeyCode.KEY_CODE_VOL_DOWN},		 	
		 			{3, 		FinalKeyCode.KEY_CODE_MUTE},
	...
	private int KeyCanKeyTableDS4H[][]=
		 {
		 			{1,			FinalKeyCode.KEY_CODE_VOL_UP},
		 			{2, 		FinalKeyCode.KEY_CODE_VOL_DOWN},		 	
		 			{3, 		FinalKeyCode.KEY_CODE_MUTE},
	...
	private int KeyCanKeyTable408[][]=
		 {
		 			...
		 			{0x11|0x80,		FinalKeyCode.KEY_CODE_PLAYER},
		 			{0x16|0x80,		FinalKeyCode.KEY_CODE_NULL},	
		 			{0x17|0x80,		FinalKeyCode.KEY_CODE_NULL},	
		 			{0x18|0x80,		FinalKeyCode.KEY_CODE_NULL},		
		 			{0x19|0x80,		FinalKeyCode.KEY_CODE_NULL},	//	KEY_CODE_PREV
	...
	private int KeyCanKeyTable508L[][]=
		 {
		 			{1,			FinalKeyCode.KEY_CODE_VOL_UP},
		 			{2, 		FinalKeyCode.KEY_CODE_VOL_DOWN},		 	
		 			{3, 		FinalKeyCode.KEY_CODE_MUTE},
	...
	private int KeyCanKeyTable508H[][]=
		 {
		 			{1,			FinalKeyCode.KEY_CODE_VOL_UP},
		 			{2, 		FinalKeyCode.KEY_CODE_VOL_DOWN},		 	
		 			{3, 		FinalKeyCode.KEY_CODE_MUTE},
	...
	private int KeyCanKeyTable508AMP[][]=
		{
				{1,			FinalKeyCode.KEY_CODE_VOL_UP},
				{2, 		FinalKeyCode.KEY_CODE_VOL_DOWN},		 	
				{3, 		FinalKeyCode.KEY_CODE_MUTE},
				...
				{0x01|0x80,		FinalKeyCode.KEY_BLACK_SCREEN},
				{0x06|0x80,		FinalKeyCode.KEY_CODE_MODE},
				{0x07|0x80,		FinalKeyCode.KEY_CODE_NEXT},
				{0x08|0x80,		FinalKeyCode.KEY_CODE_NULL},
				{0x09|0x80,		FinalKeyCode.KEY_CODE_MUTE},
				{0x0a|0x80,		FinalKeyCode.KEY_CODE_N1},
				...
				{0x19|0x80,		FinalKeyCode.KEY_CODE_BRIGHT_DEC}, 
				{0x1A|0x80,		FinalKeyCode.KEY_CODE_BRIGHT_INC},	 
				{0x24|0x80,		FinalKeyCode.KEY_CODE_NULL},		
				{0x25|0x80,		FinalKeyCode.KEY_CODE_NULL},		
				{0x27|0x80,		FinalKeyCode.KEY_CODE_NULL},
				{0x28|0x80,		FinalKeyCode.KEY_BLACK_SCREEN},
				{0x29|0x80,		FinalKeyCode.KEY_CODE_NULL},
				{0x2a|0x80,		FinalKeyCode.KEY_CODE_NULL},
				{0x2b|0x80,		FinalKeyCode.KEY_CODE_NULL},
				{0x2c|0x80,		FinalKeyCode.KEY_CODE_MODE},
	...
	private int KeyCanKeyTable40817[][]=
		 {
		 			{1,			FinalKeyCode.KEY_CODE_VOL_UP},
		 			{2, 		FinalKeyCode.KEY_CODE_VOL_DOWN},		 	
		 			{3, 		FinalKeyCode.KEY_CODE_MUTE},
...
//			 仅处理0x14 雨刷器手柄按下
			...
			onKeyEvent(keyTable, data[start + 4]&0xFF, data[start +5] &0xFF); 
...
//			HandlerTaskCanbus.update(U_CAR_CAMERA_MODE, ((data[start + 6] & 0xff) << 8) | (data[start + 7] & 0xff));
		...
		case 0x14: {
			...
			HandlerTaskCanbus.update(U_DRIVING_TOTAL_MILES, ((data[start + 6] & 0xff) << 8) | (data[start + 7] & 0xff));
			break;
		}
		case 0x15:{
			// 行车电脑信息 page2
			HandlerTaskCanbus.update(U_OPTIMAL_OIL_EXPEND_2, 			((data[start+2] & 0xff) << 8) | (data[start+3] & 0xff));
			HandlerTaskCanbus.update(U_AVERAGE_SPEED_2, 				data[start+5] & 0xff);
			HandlerTaskCanbus.update(U_DRIVING_TOTAL_MILES_2, 			((data[start+6] & 0xff) << 8) | (data[start+7] & 0xff));
			break;
		}
...
//			 仅处理0x14 雨刷器手柄按下
			...
			int[][] keyTable = getPanelKeys(); 
			onKeyEvent(keyTable, CanKey2, data[start +3] &0xFF);  
			break;
		}
		case 0x22: {
			int action = data[start + 3] & 0xFF;
		...
		case  0x81:{
			...
			HandlerTaskCanbus.update(U_MUTIL_AVERAGE_SPEED,				value81);
		...
		case  0x82:{
			...
			HandlerTaskCanbus.update(U_DRIVER_DISPLAY_DISTANCE_WARNNING,	value82);
			break;
		}
...
//		}
	...
	public void onKeyEvent(int[][] KeyCanKeyTable, int keycode, int action) {
		if (CanKey != keycode) {
			CanKey = keycode;
			int i, j = 0;
			...
			if ((tempKeyCode == (0x40 | 0X80)) && (keycode & 0x7F) == 0 && (DataCanbus.canbusId == FinalCanbus.CAR_PSA_DS5 || DataCanbus.canbusId == FinalCanbus.CAR_PSA_DS5LS
					|| DataCanbus.canbusId == FinalCanbus.CAR_PSA_DS4
					|| DataCanbus.canbusId == FinalCanbus.CAR_PSA_DS4_H)) {
					HandlerTaskCanbus.update(U_JUMP_CARINFO, new int[] { 1 });
			} else if ((tempKeyCode == 0x16 || tempKeyCode == 0x14 || (tempKeyCode == (0x27 | 0X80))) && (keycode & 0x7F) == 0) {
				HandlerTaskCanbus.update(U_JUMP_CARINFO, new int[] { 1 });
			} else {
	...
	void CarRtProc(int value) {
		...
		HandlerTaskCanbus.update(U_SET_SOS_STATE, tempFlag);
	}
	...
	public void in() {
		...
		EventNotify.NE_RADIO_BAND.addNotify(NE_APP, 1);
		EventNotify.NE_RADIO_FREQS.addNotify(NE_APP, 1);
	...
	private void setCarType(int value, boolean update) {
		if (mCarOffset != value) {
			...
			SendFunc.send2Canbus(0x24, new int[] { offset, 0 });
			if (update) {
	...
	private int[][] getPanelKeys() {
		int[][] keyTable;
		LogsUtils.i("can keys " + DataCanbus.canbusLevel);
		...
		case FinalCanbus.CAR_PSA_DS5LS:
			...
			break;
		case FinalCanbus.CAR_PSA_DS5LS_H:
			keyTable = KeyCanKeyTableDS5LSH;
			break;
		...
		case FinalCanbus.CAR_PSA_4008:
			...
			break;
		case FinalCanbus.CAR_PSA_508_AMP:
			keyTable = KeyCanKeyTable508AMP;
			break;
		default:
			keyTable = KeyCanKeyTable408;
			break;
	...
	private static void CarsSendID() {
		int vol = DataHost.sMuteSrc == 1 ? 0 : DataHost.sVolDst;
		if (lastVol == vol)
			return;
		int[] cmds = new int[3];
		int t1 = 0;
	...
	private static void CarDisNormal() {
	...
	private static void CarCanDisRadioInfo() {
		...
		cmds[0] = fmIndex;
		cmds[1] = DataHost.sRadioFreq & 0xFF;
		cmds[2] = (DataHost.sRadioFreq >> 8) & 0xFF;
		cmds[3] = DataHost.sRadioChannel + 1;
		cmds[4] = 0x00;
...
//                SendFunc.send2Canbus(0x24, ints);
        ...
        case C_SET_21:
        	if (ints != null && ints.length > 0) {
        		SendFunc.send2Canbus(0x21, ints);
        	}
        	break;
