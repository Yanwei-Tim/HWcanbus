...
//	public static final int U_CNT_MAX						= U_ENGINE_SPEED+1;
	...
	private static final int U_SET_49D0               			= U_WASH_STATE + 1; 	// 胎压保存状态
	...
	private static final int U_SET_49D30               			= U_SET_49D0 + 7;  		// 灵敏度
...
//    public static final int S_CAR_CAMERA = 0xF2;
    ...
    public static final int C_SET_TIRE		= 3;
...
//                }
            ...
            case 0x49: { // tire
    			...
    			HandlerTaskCanbus.update(U_SET_49D0, B0 & 0xFF);
    			...
    			HandlerTaskCanbus.update(U_SET_49D30, B3 & 0x0F);
                break;
            }
