...
//		PrintScreenView.getMsgView().msg("origin: " + toHexString(data));
//		opr("origin: " + toHexString(data)); 
...
//			 }
	...
	private void opr(String str){
		LogsUtils.d("FormatSerialData " + str); 
	}
	
	private void onHandler(int[] ints, int start, int len) {
		opr("onHandler: " + toHexString(ints, start, len));
		if (mListener != null) {
