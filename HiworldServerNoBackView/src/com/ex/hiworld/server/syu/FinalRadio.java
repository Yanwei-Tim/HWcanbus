...
/**
 * 概念
 * RDS:	Radio Digital System	收音数字系统
 * AF:	Alternative frequencies	信号弱时,跳到可选频率
 * TA:	Traffic Anouncement 	是否正在播放交通信息
 * PTY:	Program Type Code 		电台节目类型
 * TP:	Traffic Program	 		是否交通电台
 * PI:	Program Identification	电台识别码
 */
public class FinalRadio {
	...
	public static final int MODULE_RADIO_INNER				= 3;//4G的内部收音机
	public static final int MODULE_RADIO_ARM				= 4;//ARM外挂收音机
...
//		ints[6]:当前频率L(单位Khz)
	...
	public static final int U_SUPPROT_AM					= 29;	// 是否支持AM
