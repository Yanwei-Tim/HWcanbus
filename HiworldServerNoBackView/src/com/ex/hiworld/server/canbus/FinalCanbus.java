...
public class FinalCanbus {
    ...
    // 0 倒车， 0/1
    // 1 通道， 0~FF
    public static final int U_HW_HOST_STATE				= U_HW_BEGIN + 5;   // 更新主机状态
...
//    public static final int C_CANBUS_FRAME_TO_MTU			= C_MISC_BEGIN+12;	// 名途原车屏协议
  ...
  //25-49丰田车
	...
	public static final int CAR_HONDA_17SiBoRui			= 22 << 16 | 2;// 15思铂睿
	...
	public static final int CAR_PSA_C5					= 4 << 16 | 5;//C5
	public static final int CAR_PSA_2013C5				= 5 << 16 | 5;//2013款C5
	public static final int CAR_PSA_307					= 6 << 16 | 5;//307
	public static final int CAR_PSA_308					= 7 << 16 | 5;//308
	public static final int CAR_PSA_408					= 8 << 16 | 5;//408
	public static final int CAR_PSA_508_L				= 9 << 16 | 5;//低配508
	public static final int CAR_PSA_508_H				= 10 << 16 | 5;//高配508
	public static final int CAR_PSA_3008				= 11 << 16 | 5;//3008全拆
	public static final int CAR_PSA_DS5					= 12 << 16 | 5;//DS5
	public static final int CAR_PSA_DS5LS				= 13 << 16 | 5;//DS5LS
	public static final int CAR_PSA_2008				= 14 << 16 | 5;//2008
	public static final int CAR_PSA_DS4					= 15 << 16 | 5;//DS4
	public static final int CAR_PSA_308S				= 16 << 16 | 5;//2014款408/308S
	public static final int CAR_PSA_3008Little			= 17 << 16 | 5;//3008留小屏
	public static final int CAR_PSA_301					= 18 << 16 | 5;//301、爱丽舍
	public static final int CAR_PSA_C3XR				= 19 << 16 | 5;//C3-XR
	public static final int CAR_PSA_4008				= 20 << 16 | 5;//17款4008
	public static final int CAR_PSA_508_AMP				= 21 << 16 | 5;//508带功放
	
	public static final int CAR_PSA_DS5_H				= 22 << 16 | 5;//DS5 High
	public static final int CAR_PSA_DS5LS_H				= 23 << 16 | 5;//DS5LS High
	public static final int CAR_PSA_DS4_H				= 24 << 16 | 5;//DS4 High
	...
	public static final int CAR_MAZIDA_ALL = 10;//马自达
