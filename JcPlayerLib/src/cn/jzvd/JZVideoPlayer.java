...
//            jzVideoPlayer.setAnimation(ra);
    ...
    public static void showSupportActionBar(Context context) {
        if (ACTION_BAR_EXIST && JZUtils.getActivity(context) != null) {
            ActionBar ab = JZUtils.getActivity(context).getActionBar();
            if (ab != null) {
...
//                JZVideoPlayer.releaseAllVideos();
    ...
    public static void onChildViewAttachedToWindow(View view, int jzvdId) {
        if (JZVideoPlayerManager.getCurrentJzvd() != null && JZVideoPlayerManager.getCurrentJzvd().currentScreen == JZVideoPlayer.SCREEN_WINDOW_TINY) {
            JZVideoPlayer videoPlayer = (JZVideoPlayer) view.findViewById(jzvdId);
...
//                        mDownY = y;
    ...
    public void clearFloatScreen() {
        ...
        ViewGroup vp = (ViewGroup) (JZUtils.scanForActivity(getContext()))//.getWindow().getDecorView();
                .findViewById(Window.ID_ANDROID_CONTENT);
        JZVideoPlayer fullJzvd = (JZVideoPlayer) vp.findViewById(R.id.jz_fullscreen_id);
        JZVideoPlayer tinyJzvd = (JZVideoPlayer) vp.findViewById(R.id.jz_tiny_id);
