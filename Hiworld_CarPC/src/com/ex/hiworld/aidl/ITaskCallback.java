 ...
 * Original file: E:\\jxfWork\\ASProject\\MyApplication\\app\\src\\main\\aidl\\com\\ex\\hiworld\\aidl\\ITaskCallback.aidl
 */
...
public interface ITaskCallback extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements ITaskCallback {
        private static final String DESCRIPTOR = "com.ex.hiworld.aidl.ITaskCallback";
        ...
        private static class Proxy implements ITaskCallback {
            ...
            @Override
            public void getByte(int code, byte[] bytes, int size, String strs) throws android.os.RemoteException {
            ...
            @Override
            public void getCmd(int code, int[] ints, int size, String strs) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
