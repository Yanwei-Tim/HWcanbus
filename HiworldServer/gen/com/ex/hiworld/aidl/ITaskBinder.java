 ...
 * Original file: E:\\jxfWork\\EcProject\\HiworldServer\\src\\com\\ex\\hiworld\\aidl\\ITaskBinder.aidl
 */
package com.ex.hiworld.aidl;
public interface ITaskBinder extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.ex.hiworld.aidl.ITaskBinder
{
private static final java.lang.String DESCRIPTOR = "com.ex.hiworld.aidl.ITaskBinder";
 ...
 */
public static com.ex.hiworld.aidl.ITaskBinder asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.ex.hiworld.aidl.ITaskBinder))) {
return ((com.ex.hiworld.aidl.ITaskBinder)iin);
}
return new com.ex.hiworld.aidl.ITaskBinder.Stub.Proxy(obj);
}
...
private static class Proxy implements com.ex.hiworld.aidl.ITaskBinder
{
...
@Override public void cmd(int cmdCode, int[] ints, float[] flts, java.lang.String[] strs) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public void cmd(int cmdCode, int[] ints, float[] flts, java.lang.String[] strs) throws android.os.RemoteException;
